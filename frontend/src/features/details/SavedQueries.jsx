...
import {
    ...
    , FormControl, InputAdornment, Button
    , ToggleButtonGroup, ToggleButton, TableContainer
    , Table, TableHead, TableRow, TableBody, styled, Paper
} from '@mui/material';
...
const originalRows = [
    createData('Brazil Campaign 10981', '1 week ago', 'June 20, 2022', 'Bulk data Request'),
    createData('Lizol Revenue Last 3 months', 'May 5, 2020', '2 days Ago', 'Instant Download'),
    createData('Brazil Campaign 10982', '1 week ago', 'June 20, 2022', 'Bulk data Request'),
    createData('Lizol Revenue Last 3 months', 'May 5, 2020', '2 days Ago', 'Instant Download'),
    createData('Brazil Campaign 10983', '1 week ago', 'June 20, 2022', 'Bulk data Request'),
];
            ...
            >
                ...
                <Box display='flex' gap='1rem' >
                    ...
                    >
                        <ToggleButton
                            value="left"
                            sx={{ backgroundColor: '#46596A', color: 'white.main', ":hover": { color: 'black' } }}
                    ...
                    <TableBody>
                        {rows.map((row, ind) => (
                            <StyledTableRow key={ind}>
                                ...
                                <StyledTableCell align="center">{row.last_queried_on}</StyledTableCell>
                                <StyledTableCell align="center">{row.request_type}</StyledTableCell>
